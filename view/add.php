...
<body>
		...
		<div class="card-body">
			<form class="row g-3" action="<?php echo $ctrl->simpanSiswa();?>" method="post" name="form1">
			  ...
			  <div align="left" class="col-md-6">
			  	<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAgama" title="Tambah"><i class="bi bi-plus"></i></a>
			  </div>
    ...
    <div id="modalAgama" class="modal fade" role="dialog" style="display:none;">
      <div class="modal-dialog">
         <div class="modal-content">
            <form class="row g-3" action="#" method="POST" id="formAgama">
...
<script>
  $('formAgama').on('submit',function(e){
    e.preventDefault();
    let Agama = $("#Agama").val();
